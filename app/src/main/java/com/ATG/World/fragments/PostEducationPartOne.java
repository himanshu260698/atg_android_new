 ...
 */
public class PostEducationPartOne extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view=inflater.inflate(R.layout.fragment_post_education_part_one, container, false);
            ...
            public void onClick(View v) {
                if (NetworkUtility.isNetworkAvailable(getActivity())) {
                    if (list.size() > 0) {
                        ...
                        PostEducationPartTwo fragment=new PostEducationPartTwo();
                        fragmentTransaction.setCustomAnimations(android.R.anim.fade_in,
                                android.R.anim.fade_out);
                        fragmentTransaction.replace(R.id.main_content, fragment);
                        Bundle bundle=new Bundle();
                        bundle.putStringArrayList("groups",(ArrayList<String>)list);
