...
import com.ATG.World.adapters.MeetingsAdapter;
 ...
 */
public class MeetingsFragment extends BaseFragment implements MeetingsAdapter.OnReloadClickListener, MeetingsAdapter.OnItemClickListener {

    public static final int PAGE_SIZE = 7;
    public static final int GET_MEETUPS_FILTER = 3;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        meetingsAdapter.setOnReloadClickListener(this);
        ...
        Call<DashboardResponse> call = atgService.getDashboardData(GET_MEETUPS_FILTER, PAGE_START, Integer.parseInt(UserPreferenceManager.getUserId(getActivity())));
        calls.add(call);
    ...
    public void onReloadButtonClicked() {
        ...
        AtgService atgService = AtgClient.getClient().create(AtgService.class);
        Call<DashboardResponse> fetchAll = atgService.getDashboardData(GET_MEETUPS_FILTER, PAGE_START, Integer.parseInt(UserPreferenceManager.getUserId(getActivity())));
        calls.add(fetchAll);
    ...
    private void loadMoreItems() {
        ...
        AtgService atgService = AtgClient.getClient().create(AtgService.class);
        Call<DashboardResponse> call = atgService.getDashboardData(GET_MEETUPS_FILTER, mCurrentPage, Integer.parseInt(UserPreferenceManager.getUserId(getActivity())));
            ...
            if (dashboardResponse != null) {
                ...
                if (dashboardList != null) {
                    if (dashboardList.size() > 0) {
                        meetingsAdapter.addAll(dashboardList);
                    }
                    if (dashboardList.size() >= PAGE_SIZE) {
                        meetingsAdapter.addFooter();
                    } else {
                        isLastPage = true;
                    }
                }
    ...
    public Callback<DashboardResponse> nextFetchCallback = new Callback<DashboardResponse>() {
        ...
        public void onFailure(Call call, Throwable t) {
            ...
            if (!call.isCanceled()) {
                if (NetworkUtility.isKnownException(t)) {
                    meetingsAdapter.updateFooter(MeetingsAdapter.FooterType.ERROR);
                }
            }
