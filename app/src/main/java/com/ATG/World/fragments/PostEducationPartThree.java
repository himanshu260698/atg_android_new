 ...
 */
public class PostEducationPartThree extends Fragment {
    private AtgService atgService;
    EditText tags;
    Button finishButton,skipButton,backButton;
    ImageButton selectButton;
    String educationId,transfereedTitle;
    private Uri uri;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view=inflater.inflate(R.layout.fragment_post_education_part_three, container, false);
