...
/**
 * Created by Chetan on 30-12-2017.
 */

public class EducationAdapter extends BaseAdapter<Dashboard> {
    ...
    protected RecyclerView.ViewHolder createItemViewHolder(ViewGroup parent) {
        ...
        final EducationViewHolder holder = new EducationViewHolder(view);
    ...
    protected void bindItemViewHolder(RecyclerView.ViewHolder viewHolder, int position) {
        final EducationViewHolder holder = (EducationViewHolder) viewHolder;
